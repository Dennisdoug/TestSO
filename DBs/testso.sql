...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Sep 16, 2018 at 08:22 AM
...
--
-- Truncate table before insert `oc_affiliate_activity`
--
...
--
-- Truncate table before insert `oc_affiliate_login`
--
...
(5, 'Main IP', '', 1, '2018-09-16 00:45:26', '2018-09-16 00:45:26');
...
(1, 5, '0NYcNjtjdGxCaiJEvK1dYxjCbVcKI2Jx', 'bg23pk3p744sd3eki8ad0ti8g2', 'temp_session_5b9d458ccdc32', '::1', '2018-09-16 00:46:52', '2018-09-16 00:47:17'),
(2, 5, 'sHgB8YQvyNg8XbfFpp08kAW9KqvcERDI', 'bg23pk3p744sd3eki8ad0ti8g2', 'temp_session_5b9d45b7098db', '::1', '2018-09-16 00:47:35', '2018-09-16 00:47:41'),
(3, 5, 'jQISuH1xHdoulFIcii15t0KUKJyBHeIM', 'bg23pk3p744sd3eki8ad0ti8g2', 'temp_session_5b9d45c111dec', '::1', '2018-09-16 00:47:45', '2018-09-16 00:47:50'),
(4, 5, 'Q0rW0nZR5cLKQCe4hdOa1ZbuypuRulvp', 'bg23pk3p744sd3eki8ad0ti8g2', 'temp_session_5b9d45c9edbf0', '::1', '2018-09-16 00:47:53', '2018-09-16 00:47:57'),
(5, 5, 'J6psYdcPDPVfOnRbHQeDWUSjjwg766RB', 'bg23pk3p744sd3eki8ad0ti8g2', 'temp_session_5b9d45d02ea17', '::1', '2018-09-16 00:48:00', '2018-09-16 00:48:04'),
(6, 5, 'QWlTfRy0WG6PCH5iqq7mgy5Sw0zQKAXt', 'bg23pk3p744sd3eki8ad0ti8g2', 'temp_session_5b9d45d809c41', '::1', '2018-09-16 00:48:08', '2018-09-16 00:48:11'),
(7, 5, 'KBY2dwbEwLcoICcvUGeGUleWfP24zdV5', 'bg23pk3p744sd3eki8ad0ti8g2', 'temp_session_5b9d45e867338', '::1', '2018-09-16 00:48:24', '2018-09-16 00:48:24');
...
(2, 'US Dollar', 'USD', '', 'đ', '0', 1.00000000, 1, '2018-09-16 01:06:03');
...
) ENGINE=MyISAM AUTO_INCREMENT=2555 DEFAULT CHARSET=utf8;
...
--
-- Truncate table before insert `oc_mega_menu`
--

TRUNCATE TABLE `oc_mega_menu`;
--
...
--
-- Truncate table before insert `oc_order_custom_field`
--
...
--
-- Truncate table before insert `oc_pavblog_blog`
--

TRUNCATE TABLE `oc_pavblog_blog`;
--
...
--
-- Truncate table before insert `oc_pavblog_blog_description`
--

TRUNCATE TABLE `oc_pavblog_blog_description`;
--
...
--
-- Truncate table before insert `oc_pavblog_category`
--

TRUNCATE TABLE `oc_pavblog_category`;
--
...
--
-- Truncate table before insert `oc_pavblog_category_description`
--

TRUNCATE TABLE `oc_pavblog_category_description`;
--
...
--
-- Truncate table before insert `oc_pavblog_comment`
--

TRUNCATE TABLE `oc_pavblog_comment`;
--
...
CREATE TABLE IF NOT EXISTS `oc_product_image` (
  ...
  KEY `product_id` (`product_id`)
) ENGINE=MyISAM AUTO_INCREMENT=4364 DEFAULT CHARSET=utf8;
...
) ENGINE=MyISAM AUTO_INCREMENT=35249 DEFAULT CHARSET=utf8;
...
(35244, 0, 'config', 'config_file_ext_allowed', 'zip\r\ntxt\r\npng\r\njpe\r\njpeg\r\njpg\r\ngif\r\nbmp\r\nico\r\ntiff\r\ntif\r\nsvg\r\nsvgz\r\nzip\r\nrar\r\nmsi\r\ncab\r\nmp3\r\nqt\r\nmov\r\npdf\r\npsd\r\nai\r\neps\r\nps\r\ndoc', 0),
(35245, 0, 'config', 'config_file_mime_allowed', 'text/plain\r\nimage/png\r\nimage/jpeg\r\nimage/gif\r\nimage/bmp\r\nimage/tiff\r\nimage/svg+xml\r\napplication/zip\r\n&quot;application/zip&quot;\r\napplication/x-zip\r\n&quot;application/x-zip&quot;\r\napplication/x-zip-compressed\r\n&quot;application/x-zip-compressed&quot;\r\napplication/rar\r\n&quot;application/rar&quot;\r\napplication/x-rar\r\n&quot;application/x-rar&quot;\r\napplication/x-rar-compressed\r\n&quot;application/x-rar-compressed&quot;\r\napplication/octet-stream\r\n&quot;application/octet-stream&quot;\r\naudio/mpeg\r\nvideo/quicktime\r\napplication/pdf', 0),
(35243, 0, 'config', 'config_file_max_size', '300000', 0),
(35238, 0, 'config', 'config_compression', '5', 0),
(35239, 0, 'config', 'config_secure', '0', 0),
(35240, 0, 'config', 'config_password', '1', 0),
(35241, 0, 'config', 'config_shared', '0', 0),
(35242, 0, 'config', 'config_encryption', '', 0),
(35237, 0, 'config', 'config_robots', 'abot\r\ndbot\r\nebot\r\nhbot\r\nkbot\r\nlbot\r\nmbot\r\nnbot\r\nobot\r\npbot\r\nrbot\r\nsbot\r\ntbot\r\nvbot\r\nybot\r\nzbot\r\nbot.\r\nbot/\r\n_bot\r\n.bot\r\n/bot\r\n-bot\r\n:bot\r\n(bot\r\ncrawl\r\nslurp\r\nspider\r\nseek\r\naccoona\r\nacoon\r\nadressendeutschland\r\nah-ha.com\r\nahoy\r\naltavista\r\nananzi\r\nanthill\r\nappie\r\narachnophilia\r\narale\r\naraneo\r\naranha\r\narchitext\r\naretha\r\narks\r\nasterias\r\natlocal\r\natn\r\natomz\r\naugurfind\r\nbackrub\r\nbannana_bot\r\nbaypup\r\nbdfetch\r\nbig brother\r\nbiglotron\r\nbjaaland\r\nblackwidow\r\nblaiz\r\nblog\r\nblo.\r\nbloodhound\r\nboitho\r\nbooch\r\nbradley\r\nbutterfly\r\ncalif\r\ncassandra\r\nccubee\r\ncfetch\r\ncharlotte\r\nchurl\r\ncienciaficcion\r\ncmc\r\ncollective\r\ncomagent\r\ncombine\r\ncomputingsite\r\ncsci\r\ncurl\r\ncusco\r\ndaumoa\r\ndeepindex\r\ndelorie\r\ndepspid\r\ndeweb\r\ndie blinde kuh\r\ndigger\r\nditto\r\ndmoz\r\ndocomo\r\ndownload express\r\ndtaagent\r\ndwcp\r\nebiness\r\nebingbong\r\ne-collector\r\nejupiter\r\nemacs-w3 search engine\r\nesther\r\nevliya celebi\r\nezresult\r\nfalcon\r\nfelix ide\r\nferret\r\nfetchrover\r\nfido\r\nfindlinks\r\nfireball\r\nfish search\r\nfouineur\r\nfunnelweb\r\ngazz\r\ngcreep\r\ngenieknows\r\ngetterroboplus\r\ngeturl\r\nglx\r\ngoforit\r\ngolem\r\ngrabber\r\ngrapnel\r\ngralon\r\ngriffon\r\ngromit\r\ngrub\r\ngulliver\r\nhamahakki\r\nharvest\r\nhavindex\r\nhelix\r\nheritrix\r\nhku www octopus\r\nhomerweb\r\nhtdig\r\nhtml index\r\nhtml_analyzer\r\nhtmlgobble\r\nhubater\r\nhyper-decontextualizer\r\nia_archiver\r\nibm_planetwide\r\nichiro\r\niconsurf\r\niltrovatore\r\nimage.kapsi.net\r\nimagelock\r\nincywincy\r\nindexer\r\ninfobee\r\ninformant\r\ningrid\r\ninktomisearch.com\r\ninspector web\r\nintelliagent\r\ninternet shinchakubin\r\nip3000\r\niron33\r\nisraeli-search\r\nivia\r\njack\r\njakarta\r\njavabee\r\njetbot\r\njumpstation\r\nkatipo\r\nkdd-explorer\r\nkilroy\r\nknowledge\r\nkototoi\r\nkretrieve\r\nlabelgrabber\r\nlachesis\r\nlarbin\r\nlegs\r\nlibwww\r\nlinkalarm\r\nlink validator\r\nlinkscan\r\nlockon\r\nlwp\r\nlycos\r\nmagpie\r\nmantraagent\r\nmapoftheinternet\r\nmarvin/\r\nmattie\r\nmediafox\r\nmediapartners\r\nmercator\r\nmerzscope\r\nmicrosoft url control\r\nminirank\r\nmiva\r\nmj12\r\nmnogosearch\r\nmoget\r\nmonster\r\nmoose\r\nmotor\r\nmultitext\r\nmuncher\r\nmuscatferret\r\nmwd.search\r\nmyweb\r\nnajdi\r\nnameprotect\r\nnationaldirectory\r\nnazilla\r\nncsa beta\r\nnec-meshexplorer\r\nnederland.zoek\r\nnetcarta webmap engine\r\nnetmechanic\r\nnetresearchserver\r\nnetscoop\r\nnewscan-online\r\nnhse\r\nnokia6682/\r\nnomad\r\nnoyona\r\nnutch\r\nnzexplorer\r\nobjectssearch\r\noccam\r\nomni\r\nopen text\r\nopenfind\r\nopenintelligencedata\r\norb search\r\nosis-project\r\npack rat\r\npageboy\r\npagebull\r\npage_verifier\r\npanscient\r\nparasite\r\npartnersite\r\npatric\r\npear.\r\npegasus\r\nperegrinator\r\npgp key agent\r\nphantom\r\nphpdig\r\npicosearch\r\npiltdownman\r\npimptrain\r\npinpoint\r\npioneer\r\npiranha\r\nplumtreewebaccessor\r\npogodak\r\npoirot\r\npompos\r\npoppelsdorf\r\npoppi\r\npopular iconoclast\r\npsycheclone\r\npublisher\r\npython\r\nrambler\r\nraven search\r\nroach\r\nroad runner\r\nroadhouse\r\nrobbie\r\nrobofox\r\nrobozilla\r\nrules\r\nsalty\r\nsbider\r\nscooter\r\nscoutjet\r\nscrubby\r\nsearch.\r\nsearchprocess\r\nsemanticdiscovery\r\nsenrigan\r\nsg-scout\r\nshai\'hulud\r\nshark\r\nshopwiki\r\nsidewinder\r\nsift\r\nsilk\r\nsimmany\r\nsite searcher\r\nsite valet\r\nsitetech-rover\r\nskymob.com\r\nsleek\r\nsmartwit\r\nsna-\r\nsnappy\r\nsnooper\r\nsohu\r\nspeedfind\r\nsphere\r\nsphider\r\nspinner\r\nspyder\r\nsteeler/\r\nsuke\r\nsuntek\r\nsupersnooper\r\nsurfnomore\r\nsven\r\nsygol\r\nszukacz\r\ntach black widow\r\ntarantula\r\ntempleton\r\n/teoma\r\nt-h-u-n-d-e-r-s-t-o-n-e\r\ntheophrastus\r\ntitan\r\ntitin\r\ntkwww\r\ntoutatis\r\nt-rex\r\ntutorgig\r\ntwiceler\r\ntwisted\r\nucsd\r\nudmsearch\r\nurl check\r\nupdated\r\nvagabondo\r\nvalkyrie\r\nverticrawl\r\nvictoria\r\nvision-search\r\nvolcano\r\nvoyager/\r\nvoyager-hc\r\nw3c_validator\r\nw3m2\r\nw3mir\r\nwalker\r\nwallpaper\r\nwanderer\r\nwauuu\r\nwavefire\r\nweb core\r\nweb hopper\r\nweb wombat\r\nwebbandit\r\nwebcatcher\r\nwebcopy\r\nwebfoot\r\nweblayers\r\nweblinker\r\nweblog monitor\r\nwebmirror\r\nwebmonkey\r\nwebquest\r\nwebreaper\r\nwebsitepulse\r\nwebsnarf\r\nwebstolperer\r\nwebvac\r\nwebwalk\r\nwebwatch\r\nwebwombat\r\nwebzinger\r\nwhizbang\r\nwhowhere\r\nwild ferret\r\nworldlight\r\nwwwc\r\nwwwster\r\nxenu\r\nxget\r\nxift\r\nxirq\r\nyandex\r\nyanga\r\nyeti\r\nyodao\r\nzao\r\nzippp\r\nzyborg', 0),
(35236, 0, 'config', 'config_seo_url', '0', 0),
(35235, 0, 'config', 'config_maintenance', '0', 0),
(35234, 0, 'config', 'config_mail_alert', '', 0),
(35233, 0, 'config', 'config_mail_smtp_timeout', '5', 0),
(35232, 0, 'config', 'config_mail_smtp_port', '25', 0),
(35231, 0, 'config', 'config_mail_smtp_password', '', 0),
(35230, 0, 'config', 'config_mail_smtp_username', '', 0),
(35229, 0, 'config', 'config_mail_smtp_hostname', '', 0),
...
(35228, 0, 'config', 'config_mail_parameter', '', 0),
(35227, 0, 'config', 'config_mail_protocol', 'mail', 0),
(35226, 0, 'config', 'config_ftp_status', '0', 0),
(35225, 0, 'config', 'config_ftp_root', '', 0),
(35224, 0, 'config', 'config_ftp_password', '', 0),
(35223, 0, 'config', 'config_ftp_username', '', 0),
(35221, 0, 'config', 'config_ftp_hostname', 'localhost', 0),
...
(35222, 0, 'config', 'config_ftp_port', '21', 0),
(35220, 0, 'config', 'config_image_location_height', '50', 0),
...
(35219, 0, 'config', 'config_image_location_width', '268', 0),
(35218, 0, 'config', 'config_image_cart_height', '74', 0),
(35217, 0, 'config', 'config_image_cart_width', '74', 0),
(35216, 0, 'config', 'config_image_wishlist_height', '47', 0),
(34622, 2, 'config', 'config_template', 'so-market2', 0),
(34623, 2, 'config', 'config_layout_id', '6', 0),
(35215, 0, 'config', 'config_image_wishlist_width', '47', 0),
(35214, 0, 'config', 'config_image_compare_height', '90', 0),
...
(35213, 0, 'config', 'config_image_compare_width', '90', 0),
(35212, 0, 'config', 'config_image_related_height', '270', 0),
(35211, 0, 'config', 'config_image_related_width', '270', 0),
(35210, 0, 'config', 'config_image_additional_height', '1000', 0),
(35209, 0, 'config', 'config_image_additional_width', '1000', 0),
(35208, 0, 'config', 'config_image_product_height', '270', 0),
(35207, 0, 'config', 'config_image_product_width', '270', 0),
(35206, 0, 'config', 'config_image_popup_height', '600', 0),
(35205, 0, 'config', 'config_image_popup_width', '600', 0),
(35204, 0, 'config', 'config_image_thumb_height', '447', 0),
(35203, 0, 'config', 'config_image_thumb_width', '447', 0),
(35202, 0, 'config', 'config_image_category_height', '80', 0),
(35201, 0, 'config', 'config_image_category_width', '80', 0),
(35200, 0, 'config', 'config_icon', 'catalog/theme_favicon.png', 0),
(35199, 0, 'config', 'config_logo', 'catalog/theme_logo.png', 0),
(35198, 0, 'config', 'config_captcha', '', 0),
(35197, 0, 'config', 'config_return_status_id', '2', 0),
(35196, 0, 'config', 'config_return_id', '0', 0),
(35195, 0, 'config', 'config_affiliate_mail', '0', 0),
...
(35194, 0, 'config', 'config_affiliate_id', '4', 0),
(35193, 0, 'config', 'config_affiliate_commission', '5', 0),
(35192, 0, 'config', 'config_affiliate_auto', '0', 0),
(35191, 0, 'config', 'config_affiliate_approval', '0', 0),
(35190, 0, 'config', 'config_stock_checkout', '0', 0),
(35189, 0, 'config', 'config_stock_warning', '0', 0),
(35187, 0, 'config', 'config_api_id', '5', 0),
(35188, 0, 'config', 'config_stock_display', '0', 0),
(35186, 0, 'config', 'config_order_mail', '0', 0),
(35185, 0, 'config', 'config_fraud_status_id', '7', 0),
...
(35172, 0, 'config', 'config_customer_group_id', '1', 0),
(35173, 0, 'config', 'config_customer_group_display', '[\"1\"]', 1),
(35174, 0, 'config', 'config_customer_price', '0', 0),
(35175, 0, 'config', 'config_login_attempts', '5', 0),
(35176, 0, 'config', 'config_account_id', '3', 0),
(35177, 0, 'config', 'config_account_mail', '0', 0),
(35178, 0, 'config', 'config_invoice_prefix', 'INV-2013-00', 0),
(35179, 0, 'config', 'config_cart_weight', '1', 0),
(35180, 0, 'config', 'config_checkout_guest', '1', 0),
(35181, 0, 'config', 'config_checkout_id', '5', 0),
...
(35182, 0, 'config', 'config_order_status_id', '1', 0),
(35183, 0, 'config', 'config_processing_status', '[\"7\",\"2\"]', 1),
(35184, 0, 'config', 'config_complete_status', '[\"5\"]', 1),
(35171, 0, 'config', 'config_customer_online', '0', 0),
(35170, 0, 'config', 'config_tax_customer', 'shipping', 0),
(35169, 0, 'config', 'config_tax_default', 'shipping', 0),
(35168, 0, 'config', 'config_tax', '1', 0),
(35167, 0, 'config', 'config_voucher_max', '1000', 0),
(35166, 0, 'config', 'config_voucher_min', '1', 0),
(35164, 0, 'config', 'config_review_guest', '1', 0),
(35165, 0, 'config', 'config_review_mail', '0', 0),
(35160, 0, 'config', 'config_product_limit', '9', 0),
(35161, 0, 'config', 'config_product_description_length', '100', 0),
(35163, 0, 'config', 'config_review_status', '1', 0),
(35162, 0, 'config', 'config_limit_admin', '20', 0),
(35155, 0, 'config', 'config_currency', 'USD', 0),
(35156, 0, 'config', 'config_currency_auto', '1', 0),
(35157, 0, 'config', 'config_length_class_id', '1', 0),
(35158, 0, 'config', 'config_weight_class_id', '1', 0),
(35159, 0, 'config', 'config_product_count', '0', 0),
(35151, 0, 'config', 'config_country_id', '222', 0),
(35152, 0, 'config', 'config_zone_id', '3563', 0),
(35153, 0, 'config', 'config_language', 'en', 0),
...
(35154, 0, 'config', 'config_admin_language', 'en', 0),
...
(35144, 0, 'config', 'config_geocode', '40.705423,-74.008616', 0),
(35145, 0, 'config', 'config_email', 'ddt1328@gmail.com', 0),
(35146, 0, 'config', 'config_telephone', 'Phone : 0123456789', 0),
(35147, 0, 'config', 'config_fax', '', 0),
(35148, 0, 'config', 'config_image', 'catalog/market.png', 0),
(35149, 0, 'config', 'config_open', '', 0),
(35150, 0, 'config', 'config_comment', 'Maecenas euismod felis et purus consectetur, quis fermentum velition. Aenean egestas quis turpis vehicula.Maecenas euismod felis et purus consectetur, quis fermentum velition. Aenean egestas quis turpis vehicula.\r\nIt is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using \'Content here, content here\', making it look like readable English.', 0),
(35141, 0, 'config', 'config_name', 'Your Store', 0),
(35142, 0, 'config', 'config_owner', 'Your Store', 0),
(35143, 0, 'config', 'config_address', 'My Company, 42 avenue des Champs Elysées 75000 Paris France', 0),
(35136, 0, 'config', 'config_meta_description', 'SO Market is a new responsive OpenCart theme with clean, simple interface and lots of powerful features. It is ideal for any online stores with huge content.', 0),
(35137, 0, 'config', 'config_meta_keyword', 'opencart theme, responsive opencart theme, market store, clean design theme, multipurpose theme, opencart responsive theme, opencart themes', 0),
(35138, 0, 'config', 'config_cookie', 'dark-bottom', 0),
(35139, 0, 'config', 'config_template', 'so-market', 0),
(35140, 0, 'config', 'config_layout_id', '4', 0),
(35135, 0, 'config', 'config_meta_title', 'SO Market - Responsive Multipurpose OpenCart Theme', 0),
(35246, 0, 'config', 'config_error_display', '1', 0),
(35247, 0, 'config', 'config_error_log', '1', 0),
(35248, 0, 'config', 'config_error_filename', 'error.log', 0);
...
--
-- Truncate table before insert `oc_simple_blog_article`
--
...
--
-- Truncate table before insert `oc_simple_blog_article_description`
--
...
--
-- Truncate table before insert `oc_simple_blog_article_description_additional`
--
...
--
-- Truncate table before insert `oc_simple_blog_article_product_related`
--
...
--
-- Truncate table before insert `oc_simple_blog_article_to_category`
--
...
--
-- Truncate table before insert `oc_simple_blog_article_to_layout`
--
...
--
-- Truncate table before insert `oc_simple_blog_article_to_store`
--
...
--
-- Truncate table before insert `oc_simple_blog_author`
--
...
--
-- Truncate table before insert `oc_simple_blog_author_description`
--
...
--
-- Truncate table before insert `oc_simple_blog_category`
--
...
--
-- Truncate table before insert `oc_simple_blog_category_description`
--
...
--
-- Truncate table before insert `oc_simple_blog_category_to_layout`
--
...
--
-- Truncate table before insert `oc_simple_blog_category_to_store`
--
...
--
-- Truncate table before insert `oc_simple_blog_comment`
--
...
--
-- Truncate table before insert `oc_simple_blog_related_article`
--
...
--
-- Truncate table before insert `oc_simple_blog_view`
--
...
CREATE TABLE IF NOT EXISTS `oc_url_alias` (
  ...
  KEY `query` (`query`),
  KEY `keyword` (`keyword`)
) ENGINE=MyISAM AUTO_INCREMENT=1538 DEFAULT CHARSET=utf8;
...
(1, 1, 'admin', 'fd65eb9de42a1563ff74437f768ce940633d1998', 'sKkC4VMk7', 'John', 'Doe', 'ddt1328@gmail.com', '', '', '::1', 1, '2018-09-15 17:36:18');
...
--
-- Truncate table before insert `simple_blog_article`
--

TRUNCATE TABLE `simple_blog_article`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `simple_blog_article_description`
--

TRUNCATE TABLE `simple_blog_article_description`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `simple_blog_article_description_additional`
--

TRUNCATE TABLE `simple_blog_article_description_additional`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `simple_blog_article_product_related`
--

TRUNCATE TABLE `simple_blog_article_product_related`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `simple_blog_article_to_category`
--

TRUNCATE TABLE `simple_blog_article_to_category`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `simple_blog_article_to_layout`
--

TRUNCATE TABLE `simple_blog_article_to_layout`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `simple_blog_article_to_store`
--

TRUNCATE TABLE `simple_blog_article_to_store`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `simple_blog_author`
--

TRUNCATE TABLE `simple_blog_author`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `simple_blog_author_description`
--

TRUNCATE TABLE `simple_blog_author_description`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `simple_blog_category`
--

TRUNCATE TABLE `simple_blog_category`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `simple_blog_category_description`
--

TRUNCATE TABLE `simple_blog_category_description`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `simple_blog_category_to_layout`
--

TRUNCATE TABLE `simple_blog_category_to_layout`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `simple_blog_category_to_store`
--

TRUNCATE TABLE `simple_blog_category_to_store`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `simple_blog_comment`
--

TRUNCATE TABLE `simple_blog_comment`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `simple_blog_related_article`
--

TRUNCATE TABLE `simple_blog_related_article`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `simple_blog_view`
--

TRUNCATE TABLE `simple_blog_view`;COMMIT;
